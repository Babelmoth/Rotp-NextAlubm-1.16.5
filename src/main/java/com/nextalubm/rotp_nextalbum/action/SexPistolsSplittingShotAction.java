...
public class SexPistolsSplittingShotAction extends StandAction {
    private final LazySupplier<ResourceLocation> iconTexture;

    public SexPistolsSplittingShotAction(Builder builder) {
        super(builder);
        this.iconTexture = new LazySupplier<>(() -> new ResourceLocation(NextAlubm.MOD_ID, "textures/action/sex_pistols_splitting_shot.png"));
    }
    ...
    protected void perform(World world, LivingEntity user, IStandPower power, ActionTarget target) {
        ...
        for (int chamber = 0; chamber < 6; chamber++) {
            ...
            RevolverItem.setPiercingChamber(stack, chamber, false);
            RevolverItem.setSplittingChamber(stack, chamber, chamber == primaryChamber);
        }
